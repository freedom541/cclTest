...
public class Sort extends AbstractList<Sort.Order> implements Serializable {
    ...
    public Sort orderBy(Direction direction, String property) {
        add(new Order(direction, property));
        return this;
    }

    public Sort orderByAsc(String property) {
        add(new Order(Direction.ASC, property));
        return this;
    }

    public Sort orderByDesc(String property) {
        add(new Order(Direction.DESC, property));
        return this;
    }

    public Sort orderByCreateTimeAsc() {
        add(new Order(Direction.ASC, "createTime"));
        return this;
    }
    ...
    public Sort orderByUpdateTimeAsc() {
        add(new Order(Direction.ASC, "updateTime"));
        return this;
    }

    public Sort orderByUpdateTimeDesc() {
        add(new Order(Direction.DESC, "updateTime"));
        return this;
    }
