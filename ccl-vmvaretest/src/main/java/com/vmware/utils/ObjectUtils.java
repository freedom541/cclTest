...
public class ObjectUtils {
     ...
     */
    public static PropertySpec createPropertySpec(String objectType,
            String... properties) {
     ...
     * @return The newly created PropertySpec.
     */
    public static PropertyFilterSpec createPropertyFilterSpec(
     ...
     */
    public static void printOC(String text, ObjectContent OC) {
