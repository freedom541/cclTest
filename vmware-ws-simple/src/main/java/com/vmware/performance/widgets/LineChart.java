...
public class LineChart extends JComponent implements MouseListener,
    ...
    *-------------------------------------------------------------*/
    ...
    /**
     * @param lineSampleInterval The interval in data points at which to place vertical lines and
     ...
     *                           second.
     * @param detailFormat       Format of the text which is displayed over the component as the
     ...
     * @param averageWindow      Number of data points to do a moving average over when the mouse
